...
@WebServlet(name = "datosAlumno",urlPatterns = {"/datosAlumno"})
public class datosAlumno extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.print("<a href='datosNuevo?nombre="+alumno.getNombre()+"&grupo="+alumno.getGrupo()+"&cuatrimestre="+alumno.getCuatrimestre()+"&cuatrimestreRestante="+alumno.getCuatrimestreRestante()+"'>Enviar Datos</a>");
            }
